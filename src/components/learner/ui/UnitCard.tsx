...
// export type UnitStatus = "ACTIVE" | "LOCKED" | "COMPLETE";

// export type Unit = {
//   id: string;
//   title: string;                  // "Phần 1"
//   lessonCount: number;            // 30
//   progress: { done: number; total: number };
//   status: UnitStatus;
//   mascot?: string;                // link ảnh minh hoạ (optional)
// };
...
//       className={
//         "uc " +
//         (isLocked ? "uc--locked" : unit.status === "ACTIVE" ? "uc--active" : "uc--done")
//       }
//     >
...
//           className="uc__cta"
//           disabled={isLocked}
//           onClick={() => !isLocked && onContinue?.(unit.id)}
//         >
//           {isLocked ? "NHẢY TỚI PHẦN" : "TIẾP TỤC"}
//         </button>
//       </div>
